...
<html>
<head>
    <title>i-admin 后台管理系统 - 部门管理</title>
    <meta charset="UTF-8">
    ...
    <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="请输入部门名称" id="deptname">
        ...
        <div class="btn-toolbar">
            <div class="btn-group">
				<shiro:hasPermission name="sys:dept:add">
               		 <a href="${ctx}/sys/dept/add" class="btn btn-default btn-sm">新增</a>
				</shiro:hasPermission>
...
<script>
    var list_url = '${ctx}/sys/dept/data';
    // 初始化表格数据
    ...
    $('#btn-update').click(function () {
        ...
        if (rows.length == 0) {
            ...
            window.location.href = '${ctx}/sys/dept/update/' + rows[0].deptId;
        }
    });
    ...
    $('#btn-delete').click(function () {
        ...
        if (rows.length == 0) {
            ...
            window.parent.layer.confirm("确认删除?", {icon: 3, offset: 't'}, function () {
                $.ajax({
                    url: '${ctx}/sys/dept/delete/' + rows[0].deptId,
                    type: 'get',
