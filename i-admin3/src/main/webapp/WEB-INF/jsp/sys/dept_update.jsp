...
<html>
<head>
    <title>i-admin 后台管理系统 - 修改部门</title>
    <meta charset="UTF-8">
        ...
        <form class="form-horizontal" id="data-form" onsubmit="return false" data-parsley-validate>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="deptName" value="${dept.deptName}" class="form-control" required>
                </div>
            </div>
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.code == 0) {
                ...
                window.location.href = '${ctx}/sys/dept';
            } else {
