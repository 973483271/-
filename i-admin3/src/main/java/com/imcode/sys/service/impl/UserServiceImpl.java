...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public boolean save(User user) {
        ...
        // 校验用户名是否被占用
        QueryWrapper<User> queryUsername = new QueryWrapper<User>();
        ...
        if (!StringUtils.isEmpty(mobile)) {
            QueryWrapper<User> queryMobile = new QueryWrapper<User>();
        ...
        if (!StringUtils.isEmpty(email)) {
            QueryWrapper<User> queryEmail = new QueryWrapper<User>();
     ...
     */
	@Override
	public List<User_Role> getUser_Role(String userName) {
		return userMapper.selectUser_Role(userName);
	}
}
